...
from data.dermatomyositis_train_dataset import TrainDermatomyositis
from data.dermatomyositis_eval_dataset import EvalDermatomyositis
...
def initialize_classifier(args):
    ...
    classifier = classifier.cuda() if args.device=='cuda' else classifier
